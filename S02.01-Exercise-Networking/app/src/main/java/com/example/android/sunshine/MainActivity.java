...
public class MainActivity extends AppCompatActivity {
    ...
    public class FetchWeatherTask extends AsyncTask<String, Void, String[]> {
        ...
        protected String[] doInBackground(String... params) {
            ...
            try {
                jsonResponse = NetworkUtils.getResponseFromHttpUrl(weatherRequestUrl);
                jsonData = OpenWeatherJsonUtils.getSimpleWeatherStringsFromJson(MainActivity.this, jsonResponse);
            } catch (Exception e) {
                e.printStackTrace();
            }
